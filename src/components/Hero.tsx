    ...
    <section className="relative min-h-screen flex items-center justify-center bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 md:px-8 pt-32 sm:pt-40 pb-24 sm:pb-32 flex flex-col items-center">
        ...
        <button
          ...
          className="mt-8 sm:mt-10 bg-[#ff2c2c] text-white px-8 sm:px-12 py-3.5 sm:py-4 rounded-full text-base sm:text-lg font-bold hover:bg-[#e62828] transition-all hover:scale-[1.06] active:scale-95 hover:shadow-[0_0_20px_#ff2c2c90] shadow-lg animate-fade-in-up [animation-delay:0.25s]"
        >
          Register Now
        </button>
      </div>
